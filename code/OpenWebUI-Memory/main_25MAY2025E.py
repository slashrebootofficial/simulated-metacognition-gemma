...
app.state.config = {}  # Initialize config dictionary
...
app.state.config['SEARCHAPI_ENGIN']E = SEARCHAPI_ENGINE
...
chroma_host = app.state.config.get('CHROMA_HTTP_HOST', 'chromadb')
chroma_port = app.state.config.get('CHROMA_HTTP_PORT', 8000)
...
try:
    ...
    asyncio.run(test_chroma_connection(chroma_client))
