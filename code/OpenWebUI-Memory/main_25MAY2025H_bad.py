...
from open_webui.config import AppConfig, S
...
app.state.config = AppConfig(
    redis_url=REDIS_URL,
    redis_sentinel_hosts=get_sentinels_from_env(REDIS_SENTINEL_HOSTS, REDIS_SENTINEL_PORT),
)
