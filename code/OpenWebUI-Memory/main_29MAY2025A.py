...
try:
    ...
    log.info("Embedding model 'all-mpnet-base-v2' loaded on CUDA")
except Exception as e:
    log.error(f"Failed to load embedding model 'all-mpnet-base-v2' on CUDA: {e}")
    embedding_model = SentenceTransformer('sentence-transformers/all-mpnet-base-v2', device='cpu')
    log.info("Fallback to CPU for embedding model 'all-mpnet-base-v2'")
finally:
