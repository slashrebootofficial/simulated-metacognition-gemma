...
app.state.config = SimpleNamespace(
    ENABLE_API_KEY=app.state.config.get("ENABLE_API_KEY", False),
    CHROMA_HTTP_HOST=app.state.config.get("CHROMA_HTTP_HOST", "chromadb"),
    CHROMA_HTTP_PORT=app.state.config.get("CHROMA_HTTP_PORT", 8000),
    WEBUI_NAME=app.state.WEBUI_NAME,
    MODEL_ORDER_LIST=app.state.config.get("MODEL_ORDER_LIST", []),
    DEFAULT_MODELS=app.state.config.get("DEFAULT_MODELS", []),
    DEFAULT_PROMPT_SUGGESTIONS=app.state.config.get("DEFAULT_PROMPT_SUGGESTIONS", []),
    ENABLE_SIGNUP=app.state.config.get("ENABLE_SIGNUP", True),
    ENABLE_LOGIN_FORM=app.state.config.get("ENABLE_LOGIN_FORM", True),
    ENABLE_CHANNELS=app.state.config.get("ENABLE_CHANNELS", False),
    ENABLE_COMMUNITY_SHARING=app.state.config.get("ENABLE_COMMUNITY_SHARING", False),
    ENABLE_MESSAGE_RATING=app.state.config.get("ENABLE_MESSAGE_RATING", False),
    ENABLE_USER_WEBHOOKS=app.state.config.get("ENABLE_USER_WEBHOOKS", False),
    ENABLE_DIRECT_CONNECTIONS=app.state.config.get("ENABLE_DIRECT_CONNECTIONS", False),
    ENABLE_WEB_SEARCH=app.state.config.get("ENABLE_WEB_SEARCH", False),
    ENABLE_CODE_EXECUTION=app.state.config.get("ENABLE_CODE_EXECUTION", False),
    ENABLE_CODE_INTERPRETER=app.state.config.get("ENABLE_CODE_INTERPRETER", False),
    ENABLE_IMAGE_GENERATION=app.state.config.get("ENABLE_IMAGE_GENERATION", False),
    ENABLE_AUTOCOMPLETE_GENERATION=app.state.config.get("ENABLE_AUTOCOMPLETE_GENERATION", False),
    ENABLE_GOOGLE_DRIVE_INTEGRATION=app.state.config.get("ENABLE_GOOGLE_DRIVE_INTEGRATION", False),
    ENABLE_ONEDRIVE_INTEGRATION=app.state.config.get("ENABLE_ONEDRIVE_INTEGRATION", False),
    FILE_MAX_SIZE=app.state.config.get("FILE_MAX_SIZE", 10 * 1024 * 1024),
    FILE_MAX_COUNT=app.state.config.get("FILE_MAX_COUNT", 10),
    USER_PERMISSIONS=app.state.config.get("USER_PERMISSIONS", {}),
    WEBHOOK_URL=app.state.config.get("WEBHOOK_URL", ""),
    TTS_ENGINE=app.state.config.get("TTS_ENGINE", "none"),
    TTS_VOICE=app.state.config.get("TTS_VOICE", "alloy"),
    TTS_SPLIT_ON=app.state.config.get("TTS_SPLIT_ON", ".!?"),
    STT_ENGINE=app.state.config.get("STT_ENGINE", "none"),
)
...
app.state.config = AppConfig()  # Initialize with AppConfig
