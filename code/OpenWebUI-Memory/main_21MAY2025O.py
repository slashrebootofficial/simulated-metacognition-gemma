        ...
        def embed_text(texts):
            try:
                ...
                if embeddings.shape[-1] != 768:
                    raise ValueError(f"Unexpected embedding dimension: {embeddings.shape[-1]}, expected 768")
            ...
            if isinstance(response, StreamingResponse):
                ...
                try:
                    ...
                    async def store_interaction(user_input, response_content, base64_string):
                        ...
                        embeddings = embed_text([document]) if document != "[IMAGE_ONLY]" else None
                        context = "image_related" if base64_string else "general"
