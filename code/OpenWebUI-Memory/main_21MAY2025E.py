...
async def load_lyra_prompt(prompt_type: str = "chat"):
    try:
        async with aiofiles.open("lyra_config.json", mode="r") as f:
...
async def chat_endpoint(request: Request, payload: dict, user: User):
    try:
...
async def chat_completion(
    ...
    system_prompt: str = Depends(get_lyra_prompt)
):
